...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post itineraries_url, params: { itinerary: { cost: @itinerary.cost, description: @itinerary.description, duration: @itinerary.duration, has_many: @itinerary.has_many, name: @itinerary.name } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { cost: @itinerary.cost, description: @itinerary.description, duration: @itinerary.duration, has_many: @itinerary.has_many, name: @itinerary.name } }
